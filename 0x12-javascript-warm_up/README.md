...
13  Update this script to replace the value 12 with 89:

You are not allowed to use var

14  Write a function that returns the addition of 2 integers.

The function must be visible from outside
The name of the function must be add
You are not allowed to use var

15  Write a file that modifies the value of myVar to 333

16  Write a function that executes x times a function.

The function must be visible from outside
Prototype: function (x, theFunction)
You are not allowed to use var

17  Write a function that increments and calls a function.

The function must be visible from outside
Prototype: function (number, theFunction)
You are not allowed to use var

18  Update this script by adding a new function incr that increments the integer value.
